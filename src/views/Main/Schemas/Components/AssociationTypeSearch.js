...
export default class AssociationTypeSearch extends React.Component {
  ...
  renderCreateAssociationTypeButton = () => {
    return (
  ...
  renderCreateAssociationTypeModal = () => {
    return (
  ...
  render() {
    ...
    return (
      <div>
        {this.renderCreateAssociationTypeButton()}
        {this.renderCreateAssociationTypeModal()}
        <DataModelSearchBox
